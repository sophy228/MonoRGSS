...
namespace GameLibrary.RGSS
{
    ...
    public class Bitmap
    {
        ...
        public Bitmap(String path)
        {
            ...
            mRenderTexture = new RenderTarget2D(drm.GraphicsDevice, mTexture.Width, mTexture.Height, false, SurfaceFormat.Color, DepthFormat.None, 100, RenderTargetUsage.DiscardContents);
